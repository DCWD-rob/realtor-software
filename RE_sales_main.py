...
def open_sales_window(parent):
    ...
    window.title("Real Estate Transactions")
    ...
    # TITLE
    # -------------------------------
    tk.Label(window, text="Real Estate Transactions", font=("Arial", 24, "bold")).pack(pady=10)
    tk.Label(window, text="Manage Client, House, and Agent Data", font=("Arial", 12)).pack(pady=5)
